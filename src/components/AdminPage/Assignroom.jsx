                       ...
                       <Grid container justifyContent={"center"}>
                            <Grid size={11.5} sx={{height:"auto"}}>
                                <Box  sx={{display:"flex",alignItems:"center",marginLeft:"-10px",mt:3}}>
                                    ...
                                    <Typography   sx={{font:"Roboto",fontSize:{xs:"30px",sm:"38px"},fontWeight:600,color:"#1945D2"}}>Assign Room</Typography>
                                </Box>
                           ...
                           <Grid container flexDirection="column" p={3} spacing={3}>
                             ...
                             <Grid item py={1.5}>
                               <Box display="flex" justifyContent={"center"} gap={2}>
                                 <Button variant="contained"  sx={{width:"47%",background: 'linear-gradient(to bottom, #FF8FA3,#EF233C)', color: 'white',fontWeight: 600,borderRadius: '5px',fontSize: '21px',boxShadow: '0 4px 6px rgba(0,0,0,0.2)',textTransform: 'none','&:hover': {background: 'linear-gradient(to bottom, #FF8FA3,#EF233C)',},}} color="error">Cancel</Button>
                                 <Button variant="contained"  sx={{width:"47%",background: 'linear-gradient(to bottom,  #76EDD2,#0E76D6)', color: 'white',fontWeight: 600,borderRadius: '5px',fontSize: '21px',boxShadow: '0 4px 6px rgba(0,0,0,0.2)',textTransform: 'none','&:hover': {background: 'linear-gradient(to bottom, #76EDD2,#0E76D6)',},}} color="error">Reassign</Button>
                               </Box>
                             </Grid>
                           </Grid>
                         </Card>
